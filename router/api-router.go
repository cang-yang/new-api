...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/param-override/simulate", middleware.AdminAuth(), controller.SimulateParamOverride)
		...
		logRoute.GET("/error-incidents", middleware.AdminAuth(), controller.ListErrorIncidents)
		logRoute.GET("/error-incidents/:fingerprint", middleware.AdminAuth(), controller.GetErrorIncident)
		logRoute.PATCH("/error-incidents/:fingerprint/resolved", middleware.AdminAuth(), controller.SetErrorIncidentResolved)
